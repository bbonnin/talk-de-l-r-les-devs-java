...
<SplitElement img="img/r.jpeg" backgroundColor="white" color="white"/>

<Box is="div" p={4}>
  <h2>Langage venant des statisticiens</h2>
...
<CodeSurfer
  ...
  steps={[
    ...
    { range: [7, 13], notes: "Vecteur (le premier indice est 1 !!!)" },
    { range: [15, 22], notes: "Quelques opérations (applicables sur des vecteurs)" },
    { range: [24, 25], notes: "Nommage des items" },
    { range: [27, 33], notes: "Nommage des items" },
    { range: [35, 39], notes: "Fonctions de base: sum, mean, median, ..." }
  ]}
/>


```notes
Cf https://cran.r-project.org/doc/contrib/Short-refcard.pdf
```
...
<CodeSurfer
  title="La base - les built-in functions"
  code={require("!raw-loader!./snippets/builtin_fcts.R")}
  lang="bash"
  steps={[

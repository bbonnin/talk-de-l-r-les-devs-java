...
<Head>
  ...
  <meta name="twitter:image" content="https://raw.githubusercontent.com/bbonnin/talk-de-l-r-les-devs-java/master/nantes-jug-2018/img/card.png" />
</Head>
...
Ce talk n'est pas une introduction à GraalVM, mais plus une intro à la data science
pour les développeurs Java qui voudraient comprendre un monde étrange, le langage R
et ses méandres.
...
[https://github.com/bbonnin/graalvm-examples](https://github.com/bbonnin/graalvm-examples)
